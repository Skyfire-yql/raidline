...
- 新计划默认提供 20 个成员席位，姓名、职业、专精、职责和分组均可编辑
- 机制只记录时间点、名称、说明和阶段，不展示伤害、治疗缺口或压力计算
- 技能按“先选职业，再选技能”的两级选择器显示，不展开完整技能目录
- 内置正式服核心技能名称、职业归属与简介；支持自定义技能
- 时间横向/人员纵向与时间纵向/人员横向两种视图，并按设备记忆
...
- 核心单元测试覆盖 v1→v2 迁移、默认 20 人、职业技能过滤、冲突、预设、MRT 和时间轴换算
