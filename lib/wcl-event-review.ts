...
const KNOWN_VASHNIK_DESCRIPTIONS: Record<string, string> = {
  ...
  "catalytic bile": "Malignant Catalyst 分散圈被玩家承接时产生的伤害。",
  ...
  imbibe: "同时激活两个毒液喷泉；组合顺序在样本中预期固定。",
  malignance: "Malignant Tumor 释放的全团毒波，并施加长时间、可叠加的周期伤害；与小怪进入中场触发的 Malignant Burst 不同。",
  "malignant burst": "Living Venom 抵达中央腔体时触发的高额全团伤害，并施加可叠加的长持续伤害。",
  "malignant catalyst": "全团伤害后发射 Catalytic Bile 分散圈；每个落点至少需要一名玩家承接。",
  "miasmic coating": "Shrouded Venom 出现时获得相当于其最大生命值的吸收盾。",
  "plague froth": "生成带伤害的分散圈，随后产生十字方向的 Plague Wave；海浪命中 Malignant Tumor 会移除 Hardened Tumor。",
  "plague wave": "由 Plague Froth 后续产生的十字海浪；命中 Malignant Tumor 会移除 Hardened Tumor。",
  ...
  "siphon blood": "Siphoning Infection 目标周期性产生的范围效果：伤害附近队友，并按命中人数治疗被点者，用于清除其治疗吸收。",
  "siphoning infection": "通常点名两名玩家，造成周期伤害、治疗吸收和受到治疗量降低 100%；需要队友进入其 Siphon Blood 范围，使该机制产生的治疗清除吸收。",
  ...
  "toxic vapor": "贯穿全场的周期自然伤害；每次 Imbibe 增加层数。",
