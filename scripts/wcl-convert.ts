...
const DEFAULT_ENCOUNTER_PROFILE = "data/fixtures/vashnik-encounter-conversion-profile-v1.json";
...
function usage(message?: string): never {
  ...
  process.stderr.write([
    ...
    "  --profile-version <整数>         Encounter profile 版本（默认 1）",
...
function parseOptions(argv: string[]): Options {
  ...
  return {
    ...
    profileVersion: positiveInteger(values.get("--profile-version"), "--profile-version", 1),
